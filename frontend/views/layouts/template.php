...
<?php $this->beginPage() ?>
            ...
            <div class="row">
                <div class="col-lg-5 col-md-5 tob-contact-row">
                    <div class="topbar-contact">
                        <ul>
                            <li><i class='bx bxs-phone'></i><a href="tel:+17632275032">+1 763-227-5032</a></li>
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                        <nav class="main-nav">
                            ...
                            <div class="sidebar-contact">
                                <ul>
                                    <li class="sidebar-single-contact"><i class='bx bxs-phone'></i> <a href="tel:+17632275032">+1 763-227-5032</a></li>
    ...
    <div class="main-banner">
        <div class="banner-slider owl-carousel">
            <div class="slider-item slider-item-1" style="background: linear-gradient(rgba(48, 79, 71, 0.65) 100%, rgba(48, 79, 71, 0.65) 100%), url(/template/images/banners/banner-1.png); background-size: cover; background-position: center">
                <div class="container">
            ...
            <div class="slider-item slider-item-2" style="background:linear-gradient(rgba(48, 79, 71, 0.65) 100%, rgba(48, 79, 71, 0.65) 100%), url(/template/images/banners/banner-3.png);  background-size: cover; background-position: center">
                <div class="container">
                    <div class="slider-content wow fadeInLeft animated" data-wow-delay="300ms" data-wow-duration="1500ms" >
                        <h2>Amazing Tour In
                            Indonesia </h2>
            ...
            <div class="slider-item slider-item-3" style="background:linear-gradient(rgba(48, 79, 71, 0.65) 100%, rgba(48, 79, 71, 0.65) 100%), url(/template/images/banners/banner-4.png);  background-size: cover; background-position: center">
                <div class="container">
                    <div class="slider-content wow fadeInLeft animated" data-wow-delay="300ms" data-wow-duration="1500ms" >
                        <h2>Amazing Tour In
                            madagascar </h2>
