...
<?php $this->beginPage() ?>
    ...
    <div class="main-banner">
        <div class="banner-slider owl-carousel">
            <div class="slider-item slider-item-1" style="background: linear-gradient(rgba(47,46,46,0.45) 100%, rgba(32,40,40,0.45) 100%), url(/template/images/banners/miraki.jpg); background-size: cover; background-position: center">
                <div class="container">
                    <div class="slider-content wow fadeInLeft animated" data-wow-delay="300ms" data-wow-duration="1500ms" >
                        ...
                        <div class="banner-btn">
                            <a href="package.html" class="btn-common">Batafsil ko'rish</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="slider-item slider-item-2" style="background:linear-gradient(rgba(47,46,46,0.45) 100%, rgba(63,65,63,0.45) 100%), url(/template/images/banners/miraki2.jpg);  background-size: cover; background-position: center">
                <div class="container">
                    <div class="slider-content wow fadeInLeft animated" data-wow-delay="300ms" data-wow-duration="1500ms" >
                        <h2>Amazing Tour In
                            Indonesia </h2>
            ...
            <div class="slider-item slider-item-3" style="background:linear-gradient(rgb(47,46,46,0.45) 100%, rgba(28,31,30,0.45) 100%), url(/template/images/banners/miraki3.jpg);  background-size: cover; background-position: center">
                <div class="container">
                    <div class="slider-content wow fadeInLeft animated" data-wow-delay="300ms" data-wow-duration="1500ms" >
                        <h2>Amazing Tour In
                            madagascar </h2>
